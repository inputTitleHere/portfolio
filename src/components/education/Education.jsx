    ...
    <section className="education">
      ...
      <div className="edu-item-wrapper">
        <div className="edu-item">
          ...
          <ul>
            <li>
              1학기 수료 <span>(2023.01~2023.05)</span> (800시간)
            </li>
            ...
            <li>
              ...
              <ul>
                <li>
                  모의 SW 역량시험 A+ 달성 <span>(2023.03.10)</span>{" "}
                </li>
              </ul>
            </li>
            <li>
              Java와 Spring boot, Mysql 기반 웹 개발 교육 수강
            </li>
            <li>
            ...
            <li>
              2학기 수강 중 <span>(2023.07~진행중)</span>
            </li>
          </ul>
        </div>
        <div className="edu-item">
          ...
          <ul>
            ...
            <li>
              2달동안 C, C++언어 및 C언어로 진행되는 자료구조와 알고리즘 수업을
              수강하였습니다.{" "}
            </li>
            <li>
              자료구조와 알고리즘은 [뇌를 자극하는 알고리즘] 교재를
              사용하였으며, C언어로 진행하였습니다.
            </li>
          </ul>
          ...
          <ul>
            ...
            <li>
              순수 Java 앱 / HTML, CSS, Javascript 홈페이지 / JSP, Servlet /
              Spring Framework 프로젝트 등 진행
            </li>
            <li>
              BackEnd
              <ul>
        ...
        <div className="edu-item">
          ...
          <ul>
            <li>
              자연과학대학 : 생화학과 졸업 <span>(2016~2022)</span> | 학점 :
              4.21/4.5
            </li>
            <li>
              4학년 졸업과제로 Python을 여름방학중에 독학하여 특정 유전자의
              발현량과 mRNA들의 Alternative Splicing에 대한 상관관계를 분석하는
              프로그램을 제작하였습니다.
            </li>
            <li>
              처음으로 프로그래밍을 접하게 되었으며 프로그래밍의 기초와 언어의
              사용법에 대해 학습할 수 있었습니다.
            </li>
